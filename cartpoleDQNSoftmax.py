...
class Model_TrainTest:
    ...
    def plot_training(self, episode):
        ...
        if episode == self.max_episodes:
            plt.savefig('./cartPole/softmax/reward_plot.png', format='png', dpi=600, bbox_inches='tight')
        plt.tight_layout()
        plt.grid(True)
        plt.show()
        plt.clf()
        ...
        # Only save as file if last episode
        if episode == self.max_episodes:
            plt.savefig('./cartPole/softmax/Loss_plot.png', format='png', dpi=600, bbox_inches='tight')
        plt.tight_layout()
        plt.grid(True)
        plt.show()
...
if __name__ == '__main__':
    ...
    RL_hyperparams = {
        ...
        "RL_load_path": f'./cartPole/softmax/final_weights' + '_' + '5000' + '.pth',
        "save_path": f'./cartPole/softmax/final_weights',
        "save_interval": 500,
        "clip_grad_norm": 3,
